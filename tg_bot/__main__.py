...
I'm a group manager bot built in python3, using the python-telegram-bot library. And I'm fully [opensource](github.com/FiestaLake/tgbot)!
...
I'm a modular group management bot built in python3! Have a look at the following for an idea of some of \
